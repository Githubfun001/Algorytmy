...
namespace WinFormsApp1
{
    public partial class SortingAlgorithms : Form
    {
        ...
        private void UserInputButton(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Input only numbers separated by comma",
                    "Wrong Format",
        ...
        private void UpdateLabelOutput()
        {
            ...
            {
                numberDisplay.Text = "Numbers: " + string.Join(", ", currentNumbers);
            }
            else
            {
                numberDisplay.Text = "Numbers: " + string.Join(", ", currentNumbers.Take(maxDisplay)) + " ...";
            }
        }
        ...
        private void SortAndMeasureTime(Func<int[], int[]> sortingAlgorithm, string algorithmName)
        {
            ...
            double elapsedMilliseconds = (double)elapsedTicks / Stopwatch.Frequency * 1000; // Convert to ms

            timeDisplay.Text = $"{algorithmName} - Time elapsed: {elapsedMilliseconds:F3} ms";
        }
